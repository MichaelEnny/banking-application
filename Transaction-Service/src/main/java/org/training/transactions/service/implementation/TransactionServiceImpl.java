package com.banking.syntra.transactions.service.implementation;
...
import com.banking.syntra.transactions.exception.AccountStatusException;
import com.banking.syntra.transactions.exception.GlobalErrorCode;
import com.banking.syntra.transactions.exception.InsufficientBalance;
import com.banking.syntra.transactions.exception.ResourceNotFound;
import com.banking.syntra.transactions.external.AccountService;
import com.banking.syntra.transactions.model.TransactionStatus;
import com.banking.syntra.transactions.model.TransactionType;
import com.banking.syntra.transactions.model.dto.TransactionDto;
import com.banking.syntra.transactions.model.entity.Transaction;
import com.banking.syntra.transactions.model.external.Account;
import com.banking.syntra.transactions.model.mapper.TransactionMapper;
import com.banking.syntra.transactions.model.response.Response;
import com.banking.syntra.transactions.model.response.TransactionRequest;
import com.banking.syntra.transactions.repository.TransactionRepository;
import com.banking.syntra.transactions.service.TransactionService;
