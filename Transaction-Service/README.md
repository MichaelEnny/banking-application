# Banking-Syntra Transaction Service

## 🚀 Introduction
The Banking-Syntra Transaction Service is a microservice responsible for managing bank transactions in the Banking-Syntra platform. It provides APIs for creating, retrieving, and listing transactions.
...
## 📂 Project Structure
The project structure of the Banking-Syntra Transaction Service is as follows:
```
Banking-Syntra Transaction Service
├── src
│   ├── main
...
## 🔒 Security
The Banking-Syntra Transaction Service uses Spring Security to secure the API endpoints. Authentication and authorization are handled using JWT (JSON Web Tokens).
